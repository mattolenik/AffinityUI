...
namespace AffinityUI
{
    ...
    public class Binder<T>
    {
        ...
        Binder(BindingDirection direction)
        {
            Direction = direction;
        }
        ...
        {
            var binder = new Binder<TValue>(BindingDirection.TwoWay) { getter = getter, setter = setter };
            return binder;
        }
        ...
        {
            var binder = new Binder<TValue>(BindingDirection.OneWay) { getter = getter };
            return binder;
        }
        ...
        {
            var binder = new Binder<TValue>(BindingDirection.OneWayToSource) { setter = setter };
            return binder;
        }
